...
/* fk:pad:end */
  ...
  window.FormKit = {
    ...
    /* ⚠️ v29 — БАМП БЕЗ ПРАВКИ КИТА, и это сказано вслух. Менялся текст денежного
       договора (Start_Form_v2), а не поведение кита; номер поднят, чтобы у 39 включений и
       у самого файла не разошлись числа — правило кит-баста стережёт именно это.
       ⛔ Защита от авто-Reader построена и ЖДЁТ СЛЕДУЮЩЕГО БАМПА по слову владельца:
       ветка fix/kit-v30-no-reader. */
    KIT: 29,
